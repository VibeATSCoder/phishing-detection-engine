...
Compatibility set: detector **v3.8.1**, reviewer **v1.11.0**, optional extension client **v3.6.0**. The exact contract is recorded in `COMPATIBILITY.json`.
...
To connect `phishingshield-persian` v3.8.1, open the extension's Options page,
