...
Compatibility set: detector **v3.7.1**, reviewer **v1.10.0**, optional extension client **v3.5.0**. The exact contract is recorded in `COMPATIBILITY.json`.
...
To connect `phishingshield-persian` v3.7.1, open the extension's Options page,
